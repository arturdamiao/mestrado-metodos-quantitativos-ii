...
```{r}
coeftest(modelo_acm_hazel, vcov = vcovHC(modelo_acm_hazel, type = "HC1"))
```

## ACM_GV

```{r}
coeftest(modelo_acm_gv, vcov = vcovHC(modelo_acm_gv, type = "HC1"))
```

## ACR_HAZEL

```{r}
coeftest(modelo_acr_hazel, vcov = vcovHC(modelo_acr_hazel, type = "HC1"))
```

## ACR_CIPRIANI

```{r}
coeftest(modelo_acr_cipriani, vcov = vcovHC(modelo_acr_cipriani, type = "HC1"))
```
