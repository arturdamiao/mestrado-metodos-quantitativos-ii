...
A homocedasticidade pressupõe que os resíduos variem de forma constante ao longo dos valores previstos. Os gráficos da @fig-hetero apresentam que os erros não variam igualmente ao longo da reta. Há a presença de heterocedasticidade. 
...
O teste de normalidade dos resíduos, apresentado na @fig-normalidade, verifica se os resíduos do modelo seguem uma distribuição normal. 

```{r}
#| label: fig-normalidade
#| echo: false
#| layout-ncol: 2
#| fig-cap: "Checagem da Normalidade dos Resíduos"
#| fig-subcap:
#|   - "Modelo 1: ACM Hazel"
#|   - "Modelo 2: ACM GV"
#|   - "Modelo 3: ACR Hazel"
